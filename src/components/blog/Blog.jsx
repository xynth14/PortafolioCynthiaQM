                ...
                <div className="box_inner blog-post">
                  ...
                  <article>
                    ...
                    <div className="blog-excerpt open-sans-font pb-5">
                      ...
                      <p><b>{singleData?.description3}</b></p>
                      <p>{singleData?.description3_1}</p>
                      <p><b>{singleData?.description4}</b></p>
                      <p>{singleData?.description4_1}</p>
                      <p><b>{singleData?.description5}</b></p>
                      <p>{singleData?.description5_1}</p>
                      <p><b>{singleData?.description6}</b></p>
                      <p>{singleData?.description6_1}</p>
                      <p><b>{singleData?.description7}</b></p>
                      <p>{singleData?.description7_1}</p>
                    </div>
